...
function ItemTemplate:constructor(itemId, class, subclass, nameDE, nameEN, displayPicture, quality, flags, conditionFlags, allowedFactions, stackable, maxDurability, duration, specialscript, descriptionDE, descriptionEN)
	...
	self.m_Stackable = stackable == 1 and true or false
