...
function GUIBlankControl:setInteractable(bool) self.m_Interactable = bool end
...
function GUIBlankControl:checkControls()
	...
	-- Check if the cursor is out of the bounds of the highestParentElement -- not visible anymore
